...
from ledger_orchestrator.review.copilot import ABSTENTION, LocalModelUnavailable, ReadOnlyCopilot, local_model_settings
from ledger_orchestrator.api.gateway import ALLOWED_PATH
...
class CopilotTests(unittest.TestCase):
    ...
    def test_local_ollama_transport_checks_installed_model_first(self):
        ...
        with patch.dict('os.environ', {'CMF_LLM_MODEL': 'local-model',
                                       'CMF_LLM_URL': 'http://ollama:11434'}, clear=False), \
             patch('ledger_orchestrator.review.copilot.build_opener', return_value=Opener()):
